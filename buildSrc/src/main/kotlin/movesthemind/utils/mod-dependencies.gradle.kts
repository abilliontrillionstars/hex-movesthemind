...
abstract class MovesthemindModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<MovesthemindModDependenciesExtension>("movesthemindModDependencies")
