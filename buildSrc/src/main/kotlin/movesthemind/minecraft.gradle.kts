...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/movesthemind.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: movesthemind-common-common-refmap.json
        // fixed:   movesthemind-common.refmap.json
