package io.github.abilliontrillionstars.movesthemind.config
...
import io.github.abilliontrillionstars.movesthemind.networking.msg.MsgSyncConfigS2C

object MovesthemindConfig {
    @JvmStatic
    ...
    @Config(name = Movesthemind.MODID)
