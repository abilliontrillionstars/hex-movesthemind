package io.github.abilliontrillionstars.movesthemind.casting.actions.spells
...
object OpCongratulate : SpellAction {
    ...
    private data class Spell(val target: Entity) : RenderedSpell {
        ...
        override fun cast(env: CastingEnvironment) {
            env.printMessage("text.movesthemind.congrats".asTranslatedComponent(target.displayName));
        }
    }
}
